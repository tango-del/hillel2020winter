...
public class JsonExample {
    public static void main(String[] args) {
        String json = "{\"exchangeRate\":\"1650.0\",\"externalPaymentDetails\":\"{subscriberId=12054, smartCardId=02124108694, providerName=StarTimes, tvPackage=StarTimes, tvPackage=StartTimes, expirationDate=2019-07-13}\"}";
